...
const LightPillar = ({
  topColor = '#4F46E5', // Primary color
  bottomColor = '#06B6D4', // Accent color
  intensity = 1.0,
  rotationSpeed = 0.3,
  interactive = false,
  className = '',
  ...
  if (!webGLSupported) {
    return (
      <div 
        className={`w-full h-full absolute top-0 left-0 flex items-center justify-center bg-black/10 text-foreground-muted text-sm ${className}`} 
